...
<template>
  <div my-2>
    <h3 class="ylf-font-serif" font="black" text="2xl" mb-4>
      合作伙伴
    </h3>
    ...
    <div my-4 text="sm" opacity="60">
      ……
    </div>
    <NuxtLink class="ylf-font-serif text-lg underline" font="black" opacity="60" to="/contact">
      联系我们
    </NuxtLink>
  </div>
</template>
